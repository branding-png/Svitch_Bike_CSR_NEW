...
const PREVIEW = [
  ...
  { img: '/images/product/csr-762-red-1.webp',   alt: 'CSR 762 in Racing Red â€” side profile' },
  { img: '/images/product/csr-762-gray-1.webp',  alt: 'CSR 762 in Graphite Grey â€” side profile' },
...
export default function WishlistPreview({ extraCount = 1 }) {
  ...
  return (
    <div aria-label="WishlistPreview" className="account-section">
