...
// Gallery â€” mirrors CSR_New_web `#gl-main`.
...
const ITEMS = [
  { cat: 'studio', src: '/images/product/csr-762-red.webp',          alt: 'CSR 762 in Crimson Red â€” studio shot',     title: 'Crimson Red',     sub: 'Studio',          desc: 'Studio shot, three-quarter front angle.'           },
  ...
  { cat: 'video',  src: '/images/hero/render.mp4',                   poster: '/images/hero/hero-render-media.webp',   alt: 'CSR 762 hero reveal video poster', title: 'Hero Reveal', sub: 'Video Â· 0:30', desc: '30-second cinematic reveal of the CSR 762.' },
  ...
  { cat: 'owner',  src: '/images/product/side-profile.webp',         alt: 'Owner-submitted side profile of CSR 762',  title: '@arjun.rides',    sub: 'Owner Â· Pune',    desc: 'Tagged #SvitchCSR762 by @arjun.rides.'             },
  { cat: 'owner',  src: '/images/product/black-bike.webp',           alt: 'Owner-submitted matte black CSR 762',      title: '@ev_diaries',     sub: 'Owner Â· Bengaluru', desc: 'Tagged #SvitchCSR762 by @ev_diaries.'            },
]
    ...
    <section id="gl-main">
      <div className="container">
        ...
        <p style={{ textAlign: 'center', marginTop: 30,  }}>
          ...
          Instagram â€” selected photos featured here monthly.
        </p>
      </div>
    </section>
  )
